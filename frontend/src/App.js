...
const contractAddress = '0x2E11eaB06070CAd7C43A043CF0428E59830D3857';
  ...
  return (
    <div className="App">
      <div>
        ...
        <button onClick={() => getMessage(setCurrentMessage, setNewMessage)}>Get Message</button>
      </div>
      ...
      <div>
        ...
        />
        <button onClick={() => setMessage(newMessage, setCurrentMessage)}>Set Message</button>
      </div>
    </div>
  );
}
